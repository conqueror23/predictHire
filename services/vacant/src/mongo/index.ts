...
const updateOneDoc= async (collectionName:string,filter:Object,content:Partial<VacantFilterParam>)=>{
...
const upsertDoc=async (collectionName:string,filter:Object,content:Partial<VacantFilterParam>)=>{
